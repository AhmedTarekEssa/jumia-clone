...
export class OrderService {
  ...
  getSubOrdersBySellerId(sellerId: number): Observable<Order[]> {
    return this.http.get<Order[]>(`${this.baseUrl}${environment.Orders.GetSubOrdersBySellerId(sellerId)}`, { withCredentials: true });
  }
}
